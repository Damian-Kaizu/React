...
(
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingX} `}>
    <div className={`Hero-text flex-1 ${styles.flexStart} flex-col x1:px-0 sm:px-16 px-6`}>
      ...
      <div className="flex flex-row justify-between items-center w-full">
        <h1 className="flex-1 font-confortaa font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]">
      ...
      <h1 className="font-sfpro font-semibold ss:text-[64px] text-[52px] text-white ss:leading-[100px] leading-[75px] w-full">
        payment method
      </h1>
